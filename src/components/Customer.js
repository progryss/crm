...
export default function Customer() {
  ...
  const handleToggleColumn = (key) => {
    ...
    if (columnExists) {
      setColumns(columns.filter(column => column.id !== key));
    } else {
              ...
              <div className="col-lg-12">
                <div className="d-flex justify-content-between align-items-center">
                  <div className="d-flex align-items-center gap-2">
                    <span><i className="fas fa-user fa-sm"></i></span><span><h5 className="mb-0"><strong>Customer</strong></h5></span>
                  </div>
                  <div>
                    <button className="btn btn-primary ml-3 add-customer-btn">
